...
const CodeValidationInputSchema = z.object({
  ...
  category: z
    .string()
    .describe("The validation category (e.g., Security, Performance, Style)."),
...
const CodeValidationOutputSchema = z.object({
  passed: z.boolean().describe("Indicates whether the code passed validation."),
  ...
  violations: z
    .array(
      z.object({
        ...
        suggestion: z
          .string()
          .describe("A suggestion for fixing the violation."),
        lineNumbers: z
          .array(z.number())
          .optional()
          .describe("The line numbers where the violation occurred."),
      }),
    )
  ...
  rawOutput: z
    .string()
    .optional()
    .describe("The raw output from the language model."),
});
