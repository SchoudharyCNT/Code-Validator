...
export const mockRules: Rule[] = [
  {
    ...
    description:
      "Hardcoding credentials in code can lead to serious security breaches. Use environment variables instead.",
  ...
  },
  {
    ...
    description:
      "Frequent DOM manipulations can slow down web page performance. Batch updates or use virtual DOM libraries.",
    codeExample:
      "for (let i = 0; i < 1000; i++) { document.getElementById('el').innerHTML += i; }",
  ...
  },
  {
    ...
    description:
      "List comprehensions are often more readable and efficient than explicit for loops for creating lists.",
    codeExample: "squares = []\nfor x in range(10):\n  squares.append(x**2)",
